...
from release import version as __app_version__
...
import base64, cgi, email.utils, functools, hmac, importlib.util, itertools, mimetypes,\
...
def run(app=None, server='wsgiref', host='127.0.0.1', port=8080,
    ...
    try:
        ...
        if not server.quiet:
            _stderr("LinBox v%s server starting up (using %s)...\n" % (__app_version__, repr(server)))
